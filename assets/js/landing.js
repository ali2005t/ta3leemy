...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (settingsSnap.exists()) {
            ...
            // 3. Platform Design Layout
            if (data.landingLayout) {
                const layout = data.landingLayout;
                document.body.classList.remove('layout-v1', 'layout-v2', 'layout-v3', 'layout-v4', 'layout-v5', 'layout-v6', 'layout-v7');
                if (layout !== 'v1') document.body.classList.add(`layout-${layout}`);
            }
        }
