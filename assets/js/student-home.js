                ...
                div.innerHTML = `
                    <div style="display:flex; align-items:center; flex:1;">
                        <div class="training-logo">
                           <img src="${training.coverImage || teacherLogo || '../assets/images/icon%20platform%20.png'}" style="width:100%; height:100%; object-fit:cover; border-radius:50%;" onerror="this.onerror=null; this.src='../assets/images/icon%20platform%20.png';">
                        </div>
