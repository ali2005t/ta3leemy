        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                if (data.coverImage) {
                    ...
                    if (tId) {
                        try {
                            ...
                            if (teacherSnap.exists()) {
                                ...
                                if (logo) {
                                    imgContainer.innerHTML = `<img src="${logo}" style="width:100%; height:100%; object-fit:cover;" onerror="this.onerror=null; this.src='../assets/images/icon%20platform%20.png';">`;
                                    logoFound = true;
                                }
                            }
                        } catch (e) {
                    ...
                    if (!logoFound) {
                        imgContainer.innerHTML = `<img src="../assets/images/icon%20platform%20.png" style="width:100%; height:100%; object-fit:cover;">`;
                    }
                }
            }
        } catch (e) {
            ...
            // Fallback on error
            const imgContainer = document.getElementById('course-img-placeholder');
            if (imgContainer) imgContainer.innerHTML = `<img src="../assets/images/icon%20platform%20.png" style="width:100%; height:100%; object-fit:cover;">`;
        }
    }
